...
def plot_compactness_comparison(metrics_slpa, metrics_overlap,
    ...
    plt.tight_layout()
    plt.savefig(out_dir + "/" + "compactness_and_density_split_axis.png", dpi=300, bbox_inches='tight')
    plt.show()
...
def plot_detailed_computation_times(time_slpa, time_data_init_slpa,
    ...
    plt.savefig(out_dir + "/" + filename, format="png", dpi=300)
